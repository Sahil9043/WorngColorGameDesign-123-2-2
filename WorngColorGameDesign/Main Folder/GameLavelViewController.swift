...
class GameLavelViewController: UIViewController {
    ...
    @IBAction func easyLavelButttonTapped(_ sender: UIButton) {
        ...
        let easyLavelController = storyBoard.instantiateViewController(withIdentifier: "MidiumLavelViewController")
    ...
    @IBAction func midiumLavelButtonTapped(_ sender: UIButton) {
        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let midiumLavelController = storyBoard.instantiateViewController(withIdentifier: "MidiumLavelViewController")
    ...
    @IBAction func hardLavelButtonTapped(_ sender: UIButton) {
        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let hardLavelController = storyBoard.instantiateViewController(withIdentifier: "MidiumLavelViewController")
